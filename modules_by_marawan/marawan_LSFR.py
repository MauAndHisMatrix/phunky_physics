...
# Plotting details
PLOT_TITLE = 'Flux densities: near-UV vs mid-IR'
X_LABEL = 'Near UV (Jy/arcsec^2)'
Y_LABEL = 'Mid IR (Jy/arcsec^2)'
AUTO_X_LIMITS = True
...
def main(labels: dict = None, *jup_arrays_x_y_unc):
    """Main routine. Calls each function in turn.
    Returns:
        None"""
    if jup_arrays_x_y_unc:
        x_data, y_data, y_uncertainties = jup_arrays_x_y_unc
        global PLOT_TITLE, X_LABEL, Y_LABEL
        PLOT_TITLE = labels['plot_title']
